      ...
      <header className='py-3'>
        <div className="container">
          <nav className='d-flex justify-content-between align-items-center '>
            ...
            <ul className='d-flex justify-content-center align-items-center p-0 gap-5 mb-0 sm_screen'>
      ...
      <div className=' hero_bg pt-5'id='Home'>
        <div className='container mt-5'>
          <div className="row align-items-center">
            ...
            <div data-aos="fade-right" data-aos-duration="800" className='col-lg-6 d-flex justify-content-lg-end'>
